<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded shadow p-6 my-10 ">
        <h2 class="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-100">Create New Recipe</h2>
        ...
        <form method="POST" action="{{ route('recipes.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <x-text-input id="name" name="name" type="text" class="w-full mt-2" required />
            ...
            <div>
                ...
                <input id="image" name="image" type="file"
                    class="w-full mt-2 block text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"
...
<div>
    ...
    <!-- Static Search Input (visual only, non-functional) -->
...
@foreach ($ingredients as $ingredient)
    <label for="ingredient-{{ $ingredient->id }}" class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0 p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 cursor-pointer">
...
@endforeach
            ...
            <!-- Submit -->
            <div>
                <x-primary-button class="w-full justify-center">Create Recipe</x-primary-button>
            </div>
        </form>
    </div>
</x-app-layout>
